...
import type { BookCreationDraft } from "@atelier/core";
...
const PAGE_COPY: Record<"zh" | "en", PlatformCopy> = {
  ...
  en: {
    ...
    idleBody: "Fill in the title, genre, and story core first. Atelier will generate the foundation and open the new workspace.",
